...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PatientFlag'
        db.create_table(u'tracker_patientflag', (
        ...
        db.send_create_signal(u'tracker', ['PatientFlag'])


    def backwards(self, orm):
        # Deleting model 'PatientFlag'
        db.delete_table(u'tracker_patientflag')
