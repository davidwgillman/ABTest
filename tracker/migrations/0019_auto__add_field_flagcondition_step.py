...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FlagCondition.step'
        db.add_column(u'tracker_flagcondition', 'step',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tracker.Step']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FlagCondition.step'
        db.delete_column(u'tracker_flagcondition', 'step_id')
