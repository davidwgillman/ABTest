...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PatientStep.last'
        db.add_column(u'tracker_patientstep', 'last',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PatientStep.current'
        db.add_column(u'tracker_patientstep', 'current',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'PatientStep.last'
        db.delete_column(u'tracker_patientstep', 'last')

        # Deleting field 'PatientStep.current'
        db.delete_column(u'tracker_patientstep', 'current')

        # Adding field 'Patient.last_step'
        db.add_column(u'tracker_patient', 'last_step',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='last_step', null=True, to=orm['tracker.Step'], blank=True),
                      keep_default=False)

        # Adding field 'Patient.current_step'
        db.add_column(u'tracker_patient', 'current_step',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='current_step', null=True, to=orm['tracker.Step'], blank=True),
                      keep_default=False)
