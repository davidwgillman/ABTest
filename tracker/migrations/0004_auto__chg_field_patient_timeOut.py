...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Patient.timeOut'
        db.alter_column(u'tracker_patient', 'timeOut', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Patient.timeOut'
        db.alter_column(u'tracker_patient', 'timeOut', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 4, 28, 0, 0)))
    ...
    models = {
        ...
        u'tracker.patient': {
            ...
            'timeOut': ('django.db.models.fields.DateTimeField', [], {'null': 'True'})
        },
