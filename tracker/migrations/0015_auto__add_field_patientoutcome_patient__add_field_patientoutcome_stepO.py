...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PatientOutcome.patient'
        db.add_column(u'tracker_patientoutcome', 'patient',
        ...
        db.add_column(u'tracker_patientoutcome', 'stepOutcome',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['tracker.StepOutcome'], unique=True, null=True),
                      keep_default=False)


        # Changing field 'PatientOutcome.patientStep'
        db.alter_column(u'tracker_patientoutcome', 'patientStep_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.PatientStep'], null=True))

    def backwards(self, orm):
        # Deleting field 'PatientOutcome.patient'
        db.delete_column(u'tracker_patientoutcome', 'patient_id')
        ...
        # Changing field 'PatientOutcome.patientStep'
        db.alter_column(u'tracker_patientoutcome', 'patientStep_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tracker.PatientStep']))
    ...
    models = {
        ...
        u'tracker.patientoutcome': {
            ...
            'patientStep': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tracker.PatientStep']", 'null': 'True'}),
            'stepOutcome': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['tracker.StepOutcome']", 'unique': 'True', 'null': 'True'}),
