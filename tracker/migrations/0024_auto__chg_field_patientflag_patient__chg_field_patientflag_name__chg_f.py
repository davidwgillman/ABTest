...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PatientFlag.patient'
        db.alter_column(u'tracker_patientflag', 'patient_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tracker.Patient']))

        # Changing field 'PatientFlag.name'
        db.alter_column(u'tracker_patientflag', 'name', self.gf('django.db.models.fields.CharField')(default=None, max_length=50))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PatientFlag.patient'
        db.alter_column(u'tracker_patientflag', 'patient_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Patient'], null=True))
