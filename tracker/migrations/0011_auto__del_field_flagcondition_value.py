...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FlagCondition.value'
        db.delete_column(u'tracker_flagcondition', 'value')


    def backwards(self, orm):
        # Adding field 'FlagCondition.value'
        db.add_column(u'tracker_flagcondition', 'value',
