...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PatientOutcome.name'
        db.add_column(u'tracker_patientoutcome', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


        # Changing field 'PatientOutcome.value'
        db.alter_column(u'tracker_patientoutcome', 'value', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PatientOutcome.name'
        db.delete_column(u'tracker_patientoutcome', 'name')


        # Changing field 'PatientOutcome.value'
        db.alter_column(u'tracker_patientoutcome', 'value', self.gf('django.db.models.fields.CharField')(max_length=25))
